import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as i,o as e}from"./app-CO05rnRn.js";const l={};function p(d,s){return e(),a("div",null,[...s[0]||(s[0]=[i(`<h1 id="栈帧" tabindex="-1"><a class="header-anchor" href="#栈帧"><span>栈帧</span></a></h1><h2 id="栈" tabindex="-1"><a class="header-anchor" href="#栈"><span>栈</span></a></h2><p>从技术上来说，栈就是CPU寄存器里的某个指针所指向的一片内存区域。 栈在进程中的作用如下：</p><ul><li>暂时保存函数内的局部变量</li><li>调用函数时传递参数</li><li>保存函数返回的地址</li></ul><h2 id="栈帧-1" tabindex="-1"><a class="header-anchor" href="#栈帧-1"><span>栈帧</span></a></h2><p>栈帧也叫过程活动记录，是编译器用来实现过程/函数调用的一种数据结构。简言之，栈帧就是利用EBP（栈帧指针）寄存器访问局部变量、参数、函数返回地址等的手段。 每一次函数的调用，都会在调用栈（call stack）上维护一个独立的栈帧（stack frame）。每个独立的栈帧一般包括：</p><ul><li>函数的返回地址和参数</li><li>临时变量：包括函数的非静态局部变量以及编译器自动生成的其他临时变量</li><li>函数调用的上下文</li></ul><p>栈是从高地址向低地址延伸，一个函数的栈帧用EBP和ESP这两个寄存器来获取范围。EBP指向当前栈帧的底部，ESP始终指向栈帧的顶部。</p><ul><li>EBP寄存器又被称为帧指针（Frame Pointer）</li><li>ESP寄存器又被称为栈指针（Stack Pointer）</li></ul><p>栈帧结构图整体如下图所示：</p><h2 id="函数调用的汇编过程" tabindex="-1"><a class="header-anchor" href="#函数调用的汇编过程"><span>函数调用的汇编过程</span></a></h2><p>通过一段代码来解析</p><div class="language-c++ line-numbers-mode" data-highlighter="shiki" data-ext="c++" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-c++"><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">#include</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> &lt;stdio.h&gt;</span></span>
